...
- Нативный Wi-Fi Direct проверяется в Android-части проекта.
- Отдельная оценка криптографической стойкости.
- Отдельные прогоны BLE-доставки на Windows-оборудовании.
- Windows-артефакт в GitHub Releases: скрипт сборки есть, следующий шаг -
  собрать и проверить `.exe` на Windows.
