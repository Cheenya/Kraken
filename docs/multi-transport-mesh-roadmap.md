...
manual Device A/Device B evidence; Wi-Fi Direct still requires phone route evidence
...
| LAN NSD + TCP | implemented prototype | local Wi-Fi/LAN only, QR trust still required; manual Device A/Device B smoke captured |
| BLE GATT | implemented prototype | Android 12+ permissions, advertiser/scanner/GATT server/client and chunk codec exist; manual Device A/Device B direct-route evidence and 2026-06-08 route-specific counters captured; physical attack/rejection cases and reliability benchmark remain open |
