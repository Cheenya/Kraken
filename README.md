...
кадров QR/LAN/BLE, локального состояния, QR-импорта, LAN-событий и исходящей
очереди. Она не заменяет Android-версию.
...
для тех же исследовательских файлов внутри Android-сборки такой:
