...
fun nonActiveRelationshipReason(relationship: Relationship): String =
    when (relationship.state) {
        ...
        RelationshipState.PENDING_IMPORT -> "Проверьте приглашение перед началом рукопожатия."
        ...
        RelationshipState.BLOCKED_BY_PEER -> "Второе устройство завершило контакт. Нужно новое QR-приглашение."
