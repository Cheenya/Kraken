...
class SimulatedStoreAndForwardRelayTest {
    ...
    fun relayDisabledBlocksTransitForwarding() {
        ...
        val result = SimulatedStoreAndForwardRelay(relayEnabled = false) { 1_700_000_000_100 }
    ...
    fun enabledRelayForwardsPacketAndDecrementsTtl() {
        ...
        val result = SimulatedStoreAndForwardRelay(relayEnabled = true) { 1_700_000_000_100 }
    ...
    fun realmPolicyMustAllowRelayBeforeForwarding() {
        ...
        bobTransport.start()
        relayTransport.start()
        val relayService = SimulatedStoreAndForwardRelay(relayEnabled = true) { 1_700_000_000_100 }
