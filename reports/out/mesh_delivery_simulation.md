...
Status: automated unit-test evidence for prototype loopback and simulated store-and-forward mesh.
...
unit-test behavior. Current manual two-phone LAN/Wi-Fi prototype smoke evidence
...
./gradlew installDebug — passed on Device A ANDROID_MODEL_A / ANDROID_DEVICE_A
...
- Simulated relay is not production relay.
...
- Keystore-backed identity is not implemented.
- Packet signatures/encryption are design/interface work, not production crypto.
