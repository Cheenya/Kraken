...
Device A/Device B manual LAN/Wi-Fi prototype smoke.
...
Fresh screenshots were captured from Device A `ANDROID_MODEL_A / ANDROID_DEVICE_A` for:
...
Prototype P2P transport only. No production encryption, no account/login, no public discovery, no cloud relay.
